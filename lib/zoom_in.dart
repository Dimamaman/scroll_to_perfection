...
class Page extends StatefulWidget {
  ...
  const Page({
    ...
    Key? key,
    required this.color,
    required this.transitionPercentage,
  }) : super(key: key);
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final imageSize = isWide
                  ? math.min(
                      screenSize.height * 0.5, constraints.maxWidth * 0.42)
                  : math.min(
                      screenSize.height * 0.38, constraints.maxWidth * 0.82);
...
class InvertedCircleClipper extends CustomClipper<Path> {
  ...
  InvertedCircleClipper({required this.percentage});
